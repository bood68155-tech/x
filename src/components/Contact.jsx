    ...
    <section id="contact" className="relative py-24 sm:py-32 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form
          ...
          className="border border-[#B38F6F]/[0.08]  p-8 sm:p-10 md:p-12 bg-[#B38F6F]/[0.02]"
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <input type="text" name="name" value={formData.name} onChange={handleChange} required
                ...
                className={`w-full px-4 py-3 bg-[#B38F6F]/[0.04] border border-[#B38F6F]/[0.10]  text-[#F2F1ED] text-sm placeholder-[#767168] focus:outline-none focus:border-[#B38F6F]/40 focus:bg-[#B38F6F]/[0.06] transition-all duration-300 ${fontClass} ${ar ? 'text-base' : ''}`}
              />
            </div>
            ...
            <div>
              ...
              <select name="service" value={formData.service} onChange={handleChange} required
                className={`w-full px-4 py-3 bg-[#B38F6F]/[0.04] border border-[#B38F6F]/[0.10]  text-[#F2F1ED] text-sm focus:outline-none focus:border-[#B38F6F]/40 focus:bg-[#B38F6F]/[0.06] transition-all duration-300 appearance-none ${fontClass} ${ar ? 'text-base' : ''}`}
                style={{ backgroundImage: chevronSvg, backgroundRepeat: 'no-repeat', backgroundPosition: 'right 12px center', backgroundSize: '16px' }}
              >
                <option value="" className="bg-[#161616] text-[#B38F6F]/70">{t('contactServicePh')}</option>
          ...
          <div className="mb-8">
            ...
            <textarea name="message" value={formData.message} onChange={handleChange} required rows={5}
              ...
              className={`w-full px-4 py-3 bg-[#B38F6F]/[0.04] border border-[#B38F6F]/[0.10]  text-[#F2F1ED] text-sm placeholder-[#767168] focus:outline-none focus:border-[#B38F6F]/40 focus:bg-[#B38F6F]/[0.06] transition-all duration-300 resize-none ${fontClass} ${ar ? 'text-base' : ''}`}
            />
          </div>

          <button type="submit"
            className={`w-full py-4 bg-[#710014] text-[#F2F1ED] font-semibold text-sm  hover:bg-[#5F0B1E] transition-all duration-300 uppercase tracking-widest ${fontClass} ${ar ? 'tracking-normal normal-case text-base' : ''}`}
          >
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <a href="https://www.linkedin.com/in/abood-ahmad-697492415" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10  border border-[#B38F6F]/10 flex items-center justify-center text-[#B38F6F]/70 hover:text-[#F2F1ED] hover:border-[#B38F6F]/20 hover:bg-[#B38F6F]/5 transition-all duration-300">
