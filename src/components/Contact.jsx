    ...
    <section id="contact" className="relative py-24 sm:py-32 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form
          ...
          className="border border-white/[0.08] rounded-2xl p-8 sm:p-10 md:p-12 bg-[#B38F6F]/[0.02]"
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <input type="text" name="name" value={formData.name} onChange={handleChange} required
                ...
                className={`w-full px-4 py-3 bg-[#B38F6F]/[0.04] border border-white/[0.10] rounded-xl text-[#F2F1ED] text-sm placeholder-gray-600 focus:outline-none focus:border-[#B38F6F]/40 focus:bg-[#B38F6F]/[0.06] transition-all duration-300 ${fontClass} ${ar ? 'text-base' : ''}`}
              />
            </div>
            ...
            <div>
              ...
              <select name="service" value={formData.service} onChange={handleChange} required
                className={`w-full px-4 py-3 bg-[#B38F6F]/[0.04] border border-white/[0.10] rounded-xl text-[#F2F1ED] text-sm focus:outline-none focus:border-[#B38F6F]/40 focus:bg-[#B38F6F]/[0.06] transition-all duration-300 appearance-none ${fontClass} ${ar ? 'text-base' : ''}`}
              ...
              >
                ...
                <option value="Website" className="bg-[#050507] text-[#F2F1ED]">{t('contactService1')}</option>
                <option value="Store" className="bg-[#050507] text-[#F2F1ED]">{t('contactService2')}</option>
                <option value="Theme" className="bg-[#050507] text-[#F2F1ED]">{t('contactService3')}</option>
              </select>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <textarea name="message" value={formData.message} onChange={handleChange} required rows={5}
              ...
              className={`w-full px-4 py-3 bg-[#B38F6F]/[0.04] border border-white/[0.10] rounded-xl text-[#F2F1ED] text-sm placeholder-gray-600 focus:outline-none focus:border-[#B38F6F]/40 focus:bg-[#B38F6F]/[0.06] transition-all duration-300 resize-none ${fontClass} ${ar ? 'text-base' : ''}`}
            />
          </div>
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <a href="https://www.linkedin.com/in/abood-ahmad-697492415" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-[#B38F6F]/70 hover:text-[#F2F1ED] hover:border-white/20 hover:bg-[#B38F6F]/5 transition-all duration-300">
