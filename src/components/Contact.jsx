    ...
    <section id="contact" className="relative py-24 sm:py-32 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form
          ...
          className="border border-white/[0.08]  p-8 sm:p-10 md:p-12 bg-[#c29b7f]/[0.02]"
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <input type="text" name="name" value={formData.name} onChange={handleChange} required
                ...
                className={`w-full px-4 py-3 bg-[#c29b7f]/[0.04] border border-white/[0.10]  text-white text-sm placeholder-[#71717a] focus:outline-none focus:border-[#c29b7f]/40 focus:bg-[#c29b7f]/[0.06] transition-all duration-300 ${fontClass} ${ar ? 'text-base' : ''}`}
              />
            </div>
            ...
            <div>
              ...
              <select name="service" value={formData.service} onChange={handleChange} required
                className={`w-full px-4 py-3 bg-[#c29b7f]/[0.04] border border-white/[0.10]  text-white text-sm focus:outline-none focus:border-[#c29b7f]/40 focus:bg-[#c29b7f]/[0.06] transition-all duration-300 appearance-none ${fontClass} ${ar ? 'text-base' : ''}`}
          ...
          <div className="mb-8">
            ...
            <textarea name="message" value={formData.message} onChange={handleChange} required rows={5}
              ...
              className={`w-full px-4 py-3 bg-[#c29b7f]/[0.04] border border-white/[0.10]  text-white text-sm placeholder-[#71717a] focus:outline-none focus:border-[#c29b7f]/40 focus:bg-[#c29b7f]/[0.06] transition-all duration-300 resize-none ${fontClass} ${ar ? 'text-base' : ''}`}
            />
          </div>

          <button type="submit"
            className={`w-full py-4 bg-[#800020] text-white font-semibold text-sm  hover:bg-[#6b0c22] transition-all duration-300 uppercase tracking-widest ${fontClass} ${ar ? 'tracking-normal normal-case text-base' : ''}`}
          >
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <a href="https://www.linkedin.com/in/abood-ahmad-697492415" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10  border border-white/10 flex items-center justify-center text-[#c29b7f]/70 hover:text-white hover:border-white/20 hover:bg-[#c29b7f]/5 transition-all duration-300">
