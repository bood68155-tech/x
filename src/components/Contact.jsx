    ...
    <section id="contact" className="relative py-24 sm:py-32 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              >
                ...
                <option value="Website" className="bg-black text-white">{t('contactService1')}</option>
                <option value="Store" className="bg-black text-white">{t('contactService2')}</option>
                <option value="Theme" className="bg-black text-white">{t('contactService3')}</option>
              </select>
            </div>
          </div>
        ...
        <div className="mt-12 text-center">
          <p className={`text-xs text-gray-600 mb-4 uppercase tracking-widest ${fontClass}`}>Connect with us</p>
          <div className="flex items-center justify-center gap-4">
            <a href="https://www.linkedin.com/in/abood-ahmad-697492415" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-gray-500 hover:text-white hover:border-white/30 hover:bg-white/5 transition-all duration-300">
