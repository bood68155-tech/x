    ...
    <section className="relative py-24 sm:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-start">
          ...
          >
            <div className="w-12 h-12 rounded-xl bg-[#B38F6F]/[0.06] border border-white/[0.10] flex items-center justify-center mb-6">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#B38F6F]/[0.06] border border-white/[0.08] mb-6">
