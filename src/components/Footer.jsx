          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[t('footerCo1'), t('footerCo2'), t('footerCo3'), t('footerCo4')].map((item, i) => {
                ...
                return (
                  <li key={item}>
                    <a href={hrefs[i]} className={`text-sm text-gray-500 hover:text-white transition-colors font-light ${fontClass}`}>
                      {item}
                    </a>
                  </li>
                )
        ...
        <div className="pt-8 border-t border-white/[0.06] mb-8">
          <div className="flex items-center justify-center gap-4">
            <a href="https://www.linkedin.com/in/abood-ahmad-697492415" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10 rounded-xl border border-white/[0.08] flex items-center justify-center text-gray-500 hover:text-white hover:border-white/[0.25] hover:bg-white/5 transition-all duration-300">
