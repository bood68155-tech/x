      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            <a href="#" className="text-2xl font-black tracking-[-0.03em] text-white hover:opacity-80 transition-opacity">
              Abood
            </a>
        ...
        <div className="pt-8 border-t border-white/[0.06] mb-8">
          <div className="flex items-center justify-center gap-5">
            <a href="https://www.linkedin.com/in/abood-ahmad-697492415" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10 rounded-full border border-white/[0.08] flex items-center justify-center text-gray-500 hover:text-white hover:border-white/[0.25] hover:bg-white/5 transition-all duration-300">
