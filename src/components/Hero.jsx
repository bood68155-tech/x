...
export default function Hero({ onGetStarted }) {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-24 pb-16">
      ...
      <div className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-[800px] h-[800px]  blur-[200px] opacity-[0.03]" style={{ background: 'radial-gradient(circle, #800020 0%, transparent 70%)' }} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="animate-fade-in-up opacity-0">
              <span className="inline-flex items-center gap-2 px-4 py-2  border border-white/[0.08] bg-white/[0.03] text-xs font-semibold text-[#c29b7f] uppercase tracking-[0.2em]">
                <span className="w-2 h-2  bg-[#c29b7f] animate-pulse" />
                {t('heroHello')}
              </span>
            </div>
            ...
            <div className="animate-fade-in-up opacity-0 delay-300 grid grid-cols-1 sm:grid-cols-3 gap-3">
              <a href="mailto:bood68155@gmail.com" className="block">
                <SpotlightCard className="bento-card p-4 glow-border-hover flex items-center gap-3 group" spotlightSize={300} spotlightOpacity={0.08}>
                  <div className="w-10 h-10  bg-[#c29b7f]/[0.06] border border-white/[0.08] flex items-center justify-center group-hover:bg-[#c29b7f]/[0.12] transition-all">
            ...
            <div className="animate-fade-in-up opacity-0 delay-400 flex flex-col sm:flex-row items-start gap-4">
              <button
                ...
                className={`group relative px-8 py-4  font-semibold text-sm uppercase tracking-widest transition-all duration-300 hover:scale-[1.02] overflow-hidden bg-[#800020] text-white hover:bg-[#6b0c22] ${fontClass} ${ar ? 'tracking-normal text-base' : ''}`}
              >
                {t('heroCta')}
              </button>
              <a
                href="#projects"
                className={`px-8 py-4  font-medium text-sm uppercase tracking-widest transition-all duration-300 border border-white/[0.12] text-white/70 hover:text-white hover:border-[#c29b7f]/30 hover:bg-[#c29b7f]/[0.05] backdrop-blur-sm ${fontClass} ${ar ? 'tracking-normal text-base' : ''}`}
              >
                {t('heroSecondary')}
              </a>
            </div>
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end animate-slide-in-right opacity-0 delay-300">
            <div className="relative">
              <div className="relative w-64 h-64 sm:w-80 sm:h-80  overflow-hidden glow-border animate-float">
                ...
                {avatarUrl ? (
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-20 h-20 sm:w-24 sm:h-24  bg-[#c29b7f]/[0.07] border border-white/[0.10] flex items-center justify-center mx-auto mb-4">
                ...
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#c29b7f]/[0.04] -bl-full" />
                <div className="absolute bottom-0 left-0 w-24 h-24 bg-white/[0.02] -tr-full" />
              </div>
              <div className="absolute -bottom-4 -left-4 px-4 py-2 bg-[#111116] border border-white/[0.10]  animate-float" style={{ animationDelay: '1s' }}>
              ...
              <div className="absolute -top-3 -right-3 px-3 py-1.5 bg-[#c29b7f]/10 border border-white/20  flex items-center gap-1.5">
                <span className="w-1.5 h-1.5  bg-[#c29b7f] animate-pulse" />
