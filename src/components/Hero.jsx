...
export default function Hero({ onGetStarted }) {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-24 pb-16">
      ...
      <div className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-[800px] h-[800px] rounded-full blur-[160px] opacity-[0.04]" style={{ background: 'radial-gradient(circle, #ffffff 0%, transparent 70%)' }} />

      {/* Ambient background blobs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
        <div className="animate-blob-1 absolute -top-24 right-[10%] w-[400px] h-[400px] rounded-full bg-red-500/[0.025] blur-[120px]" />
        <div className="animate-blob-2 absolute top-[40%] -left-32 w-[500px] h-[500px] rounded-full bg-blue-500/[0.025] blur-[130px]" />
        <div className="animate-blob-3 absolute bottom-[-10%] right-[20%] w-[350px] h-[350px] rounded-full bg-purple-500/[0.025] blur-[110px]" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="animate-fade-in-up opacity-0">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/[0.08] bg-white/[0.03] text-xs font-semibold text-gray-400 uppercase tracking-[0.2em]">
            ...
            <div className="animate-fade-in-up opacity-0 delay-100">
              <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white leading-[0.95] tracking-tight ${fontClass}`}>
                {t('heroNameLine1')}
                <br />
            ...
            <div className="animate-fade-in-up opacity-0 delay-200">
              <p className={`text-base sm:text-lg text-gray-400 font-light leading-relaxed max-w-xl ${fontClass}`}>
                {t('heroBio')}
              </p>
            </div>
            ...
            <div className="animate-fade-in-up opacity-0 delay-300 grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <a href="mailto:bood68155@gmail.com" className="block">
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-white/[0.05] border border-white/[0.08] flex items-center justify-center group-hover:bg-white/[0.1] transition-all">
                    <svg className="w-4 h-4 text-gray-400 group-hover:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-300 truncate font-medium">bood68155@gmail.com</p>
                  </div>
                </SpotlightCard>
              </a>
              ...
              <a href="https://www.linkedin.com/in/abood-ahmad-697492415" target="_blank" rel="noopener noreferrer" className="block">
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-300 truncate font-medium">Abood Ahmad</p>
                  </div>
                </SpotlightCard>
              </a>
              ...
              <a href="https://github.com/bood68155-tech" target="_blank" rel="noopener noreferrer" className="block">
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-300 truncate font-medium">@bood68155-tech</p>
                  </div>
                </SpotlightCard>
              </a>
            </div>
            ...
            <div className="animate-fade-in-up opacity-0 delay-400 flex flex-col sm:flex-row items-start gap-4">
              <button
                ...
                className={`group relative px-8 py-4 rounded-xl font-semibold text-sm uppercase tracking-widest transition-all duration-500 hover:scale-[1.02] animate-pulse-glow overflow-hidden bg-white text-black hover:bg-gray-200 ${fontClass} ${ar ? 'tracking-normal text-base' : ''}`}
              >
                {t('heroCta')}
              </button>
              <a
                href="#projects"
                className={`px-8 py-4 rounded-xl font-medium text-sm uppercase tracking-widest transition-all duration-500 border border-white/[0.12] text-white/70 hover:text-white hover:border-white/[0.25] hover:bg-white/[0.04] backdrop-blur-sm ${fontClass} ${ar ? 'tracking-normal text-base' : ''}`}
              >
                {t('heroSecondary')}
              </a>
            </div>
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end animate-slide-in-right opacity-0 delay-300">
            <div className="relative">
              ...
              {/* Floating badge */}
              <div className="absolute -bottom-4 -left-4 px-4 py-2 bg-[#0f0f12] border border-white/[0.1] rounded-xl animate-float" style={{ animationDelay: '1s' }}>
                <p className="text-[10px] text-gray-500 uppercase tracking-wider">Based in</p>
                <p className="text-xs font-bold text-white">Gaza, Palestine</p>
              </div>
              {/* Status badge */}
              <div className="absolute -top-3 -right-3 px-3 py-1.5 bg-emerald-500/10 border border-emerald-500/20 rounded-full flex items-center gap-1.5">
