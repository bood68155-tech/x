          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex items-center gap-3">
              <a href="https://www.linkedin.com/in/abood-ahmad-697492415" target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center border border-white/[0.10] text-[#c29b7f]/70 hover:text-white hover:border-[#c29b7f]/70 hover:bg-[#c29b7f]/5 transition-all duration-300">
            ...
            {/* Divider */}
            <div className="hidden sm:block w-[1px] h-5 bg-white/[0.10]" />

            {/* Language Toggle */}
            <button
              onClick={toggleLanguage}
              className="flex items-center border border-white/[0.10] overflow-hidden hover:border-[#c29b7f]/70 transition-all duration-300"
            >
