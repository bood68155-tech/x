    ...
    <>
      ...
      <nav
        className={`fixed top-4 left-1/2 -translate-x-1/2 z-50 transition-all duration-500  ${
          scrolled
            ? 'bg-[#161616]/90 backdrop-blur-2xl border border-[#B38F6F]/[0.08] shadow-2xl shadow-black/50 w-[calc(100%-2rem)] max-w-4xl lg:max-w-6xl px-4 sm:px-6'
            : 'bg-[#161616]/60 backdrop-blur-xl border border-[#B38F6F]/[0.06] w-[calc(100%-2rem)] max-w-4xl lg:max-w-6xl px-4 sm:px-6'
        }`}
      >
        <div className="flex h-20 items-center justify-between gap-3">
          {/* Brand */}
          <Link to="/" className="flex items-center gap-2 group">
            <div className="w-8 h-8  bg-[#B38F6F] overflow-hidden border border-[#B38F6F]/10 group-hover:scale-110 transition-transform duration-300">
              {avatarUrl ? (
                <img src={avatarUrl} alt="Abood" className="w-full h-full object-cover" />
              ) : (
                <span className="text-[#161616] text-sm font-extrabold flex items-center justify-center w-full h-full">A</span>
              )}
            </div>
            <div className="hidden md:block min-w-0">
              <span className="block text-sm font-bold text-[#F2F1ED] tracking-tight leading-tight whitespace-nowrap">Abdelrahman Osama</span>
              <span className="text-[10px] text-[#B38F6F]/70 block leading-none whitespace-nowrap">Abood</span>
            </div>
          </Link>
            ...
            {navLinks.map((link) => (
              link.isRoute ? (
                ...
                <a
                  ...
                  className="px-3 py-1.5 text-[11px] font-medium text-[#B38F6F]/70 hover:text-[#F2F1ED] hover:bg-[#B38F6F]/[0.06]  transition-all duration-300 tracking-wide"
                >
                  {link.label}
                </a>
              )
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex items-center gap-3">
              <a href="https://www.linkedin.com/in/abood-ahmad-697492415" target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-none border border-[#B38F6F]/20 text-[#B38F6F] hover:text-[#F2F1ED] hover:border-[#710014] hover:bg-[#710014]/10 transition-all duration-300">
            ...
            {/* Divider */}
            <div className="hidden sm:block w-[1px] h-5 bg-[#B38F6F]/[0.10]" />

            {/* Language Toggle */}
            <button
              onClick={toggleLanguage}
              className="flex items-center border border-[#B38F6F]/[0.10] overflow-hidden hover:border-[#B38F6F]/70 transition-all duration-300"
            >
              <span className={`px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider transition-all duration-300 ${
                language === 'en' ? 'bg-[#B38F6F] text-[#161616]' : 'text-[#B38F6F]/70 hover:text-[#F2F1ED]'
              }`}>EN</span>
              <span className={`px-2.5 py-1 text-[10px] font-bold transition-all duration-300 ${
                language === 'ar' ? 'bg-[#B38F6F] text-[#161616]' : 'text-[#B38F6F]/70 hover:text-[#F2F1ED]'
              }`}>ع</span>
            </button>
            ...
            {showAuthUI && (
              isAuthenticated ? (
                isAdmin ? (
                  <div className="relative">
                    <button
                      ...
                      className="flex items-center gap-2 px-3 py-1.5 bg-[#710014] text-[#F2F1ED] text-[11px] font-bold  hover:bg-[#5F0B1E] transition-all duration-300"
                    >
                    ...
                    {adminMenuOpen && (
                      <div className="absolute right-0 top-full mt-2 w-56 py-2 bg-[#161616]/95 backdrop-blur-xl border border-[#B38F6F]/[0.08]  shadow-2xl shadow-black/50 animate-fade-in">
                        <div className="px-4 py-3 border-b border-[#B38F6F]/[0.06]">
                        ...
                        <div className="mx-3 my-1 border-t border-[#B38F6F]/[0.06]" />
                        <button
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex items-center gap-1.5 px-2.5 py-1  border border-[#B38F6F]/20 bg-[#B38F6F]/5">
                      <span className="relative flex h-1.5 w-1.5">
                        <span className="animate-ping absolute inline-flex h-full w-full  bg-[#B38F6F] opacity-75" />
                        <span className="relative inline-flex  h-1.5 w-1.5 bg-[#B38F6F]" />
                      </span>
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 border border-[#B38F6F]/[0.10] text-[#F2F1ED]/80 text-[11px] font-medium  hover:text-[#F2F1ED] hover:border-[#B38F6F]/[0.18] transition-all duration-300"
                >
            ...
            {/* Mobile Toggle */}
            <button
              className="xl:hidden text-[#F2F1ED] p-1.5"
        ...
        {/* Mobile Menu */}
        {mobileOpen && (
          <div className="xl:hidden mt-3 pt-3 border-t border-[#B38F6F]/[0.06]">
              ...
              {navLinks.map((link) => (
                link.isRoute ? (
                  ...
                  <a
                    ...
                    href={link.href}
                    onClick={(e) => handleNavClick(e, link.href)}
                    className="px-4 py-2 text-sm font-medium text-[#B38F6F]/70 hover:text-[#F2F1ED] hover:bg-[#B38F6F]/[0.06]  transition-all"
                  >
                    {link.label}
                  </a>
                )
      ...
      {loginOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
          <div className="absolute inset-0 bg-[#161616]/80 backdrop-blur-sm animate-fade-in" onClick={resetLoginModal} />

          <div className="relative w-full max-w-sm bg-[#161616] border border-[#B38F6F]/[0.08]  p-8 shadow-2xl shadow-black/60 animate-fade-in-up">
            <button
              onClick={resetLoginModal}
              className="absolute top-4 right-4 p-1.5 text-[#B38F6F]/70 hover:text-[#F2F1ED] transition-colors  hover:bg-[#B38F6F]/5"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="text-center mb-6">
              <div className="inline-flex items-center justify-center w-12 h-12  border border-[#B38F6F]/[0.08] bg-[#B38F6F]/5 mb-4">
            ...
            {!googleUnavailable && (
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-2.5 bg-[#B38F6F]/5 border border-[#B38F6F]/[0.12]  text-[#F2F1ED] text-sm font-medium hover:bg-[#B38F6F]/10 hover:border-[#B38F6F]/20 transition-all disabled:opacity-50 mb-4"
              >
            ...
            {googleUnavailable && (
              <div className="flex items-start gap-3 p-3  bg-[#B38F6F]/5 border border-[#B38F6F]/[0.08] mb-4">
            ...
            <form onSubmit={handleEmailAuth} className="space-y-3">
              <input
                ...
                required
                autoFocus
                className="w-full px-4 py-2.5 bg-[#B38F6F]/5 border border-[#B38F6F]/[0.08]  text-[#F2F1ED] text-sm placeholder-[#B38F6F]/40 focus:outline-none focus:border-[#B38F6F]/25 transition-all"
              />
              <input
                type="password"
                value={password}
              ...
              <button
                type="submit"
                disabled={loginLoading}
                className="w-full py-2.5 bg-[#710014] text-[#F2F1ED] text-sm font-semibold  hover:bg-[#5F0B1E] transition-all disabled:opacity-50"
              >
                {loginLoading ? (
