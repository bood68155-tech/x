...
const GRADIENTS = [
  'from-[#161616] to-[#161616]',
  'from-[#161616] to-black',
  'from-[#161616] to-[#161616]',
  'from-[#161616] to-[#161616]',
  'from-black to-[#161616]',
  'from-[#161616] to-[#161616]',
]
            ...
            >
              ...
              <div className={`relative h-52 sm:h-56 bg-gradient-to-br ${GRADIENTS[i % GRADIENTS.length]} overflow-hidden`}>
                <div className="absolute top-3 left-3 right-3 h-5  bg-[#161616]/30 flex items-center gap-1.5 px-2 z-10">
                  ...
                  <div className="w-1.5 h-1.5  bg-[#B38F6F]/60" />
                ...
                <div className="absolute inset-0 bg-[#161616]/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center z-20">
                  <span className={`px-5 py-2.5 border border-[#B38F6F]/20 text-[#F2F1ED] text-xs font-medium  uppercase tracking-wider hover:bg-white hover:text-black transition-all duration-300 ${ar ? 'tracking-normal normal-case text-sm' : ''}`}>
                    {t('portView')}
                  </span>
                </div>
              </div>
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-1">
                <div className="flex items-start justify-between mb-2 gap-2">
                  ...
                  <span className={`text-[10px] font-semibold uppercase tracking-wider px-2.5 py-1  bg-[#B38F6F]/[0.07] text-[#B38F6F] border border-[#B38F6F]/[0.08] shrink-0 ${ar ? 'tracking-normal normal-case text-xs' : ''}`}>
                    {project.tag}
                  </span>
                </div>
                ...
                {project.price && (
                  <div className="mt-3 pt-3 border-t border-[#B38F6F]/[0.06]">
