...
export default function Portfolio() {
  ...
  const projects = [
    { title: t('port1Title'), category: t('port1Cat'), description: t('port1Desc'), gradient: 'from-gray-800 to-gray-900', tag: t('port1Tag') },
    { title: t('port2Title'), category: t('port2Cat'), description: t('port2Desc'), gradient: 'from-gray-900 to-black', tag: t('port2Tag') },
    { title: t('port3Title'), category: t('port3Cat'), description: t('port3Desc'), gradient: 'from-gray-800 to-gray-900', tag: t('port3Tag') },
    { title: t('port4Title'), category: t('port4Cat'), description: t('port4Desc'), gradient: 'from-gray-900 to-gray-800', tag: t('port4Tag') },
    { title: t('port5Title'), category: t('port5Cat'), description: t('port5Desc'), gradient: 'from-black to-gray-900', tag: t('port5Tag') },
    { title: t('port6Title'), category: t('port6Cat'), description: t('port6Desc'), gradient: 'from-gray-800 to-gray-900', tag: t('port6Tag') },
  ]
