          ...
          {plans.map((plan, i) => (
            <div
              ...
              className={`relative p-8 sm:p-10  border transition-all duration-500 ${
                plan.popular
                  ? 'border-[#B38F6F]/20 bg-[#B38F6F]/[0.05] scale-[1.02]'
                  : 'border-[#B38F6F]/[0.08] bg-[#B38F6F]/[0.02] hover:border-[#B38F6F]/10'
              }`}
            >
              {plan.popular && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                  <span className={`px-4 py-1.5 bg-[#710014] text-[#F2F1ED] text-[10px] font-bold uppercase tracking-[0.2em]  ${ar ? 'tracking-normal normal-case text-xs' : ''}`}>
                    {t('pricePopular')}
                  </span>
                </div>
              )}
              ...
              <div className="flex items-baseline gap-2 mb-4">
                <span className={`text-4xl sm:text-5xl font-extrabold text-[#F2F1ED] tracking-tighter ${ar ? 'font-[\'Noto_Kufi_Arabic\',sans-serif]' : ''}`}>
                  {plan.price}
                </span>
              ...
              <a
                ...
                className={`block w-full text-center py-3.5  text-sm font-semibold transition-all duration-300 uppercase tracking-wider ${
                  plan.popular
                    ? 'bg-[#710014] text-[#F2F1ED] hover:bg-[#5F0B1E]'
