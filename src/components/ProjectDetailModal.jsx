...
export default function ProjectDetailModal({ project, onClose, onBuy }) {
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 sm:p-6">
      ...
      {/* Modal Window */}
      <div className="relative w-full max-w-5xl max-h-[85vh] bg-[#0f0f12] border border-white/[0.08] rounded-2xl shadow-2xl shadow-black/80 overflow-hidden animate-fade-in-up flex flex-col">
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b border-white/[0.06] bg-white/[0.02] shrink-0">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-gray-500 font-medium truncate max-w-[240px]">{project.title}</span>
          </div>
            ...
            <div className="p-5 sm:p-6 flex flex-col">
              ...
              {!showCheckout ? (
                ...
                <div className="text-center py-6">
                  ...
                  <button onClick={resetCheckout} className="block mx-auto text-xs text-gray-600 hover:text-gray-400 transition-colors">← Back to project</button>
                </div>
