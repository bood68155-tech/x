    ...
    <section id="services" className="relative py-24 sm:py-32 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
          ...
          {services.map((service, i) => (
            <SpotlightCard
              ...
              className={`group bento-card p-7 sm:p-8 glow-border-hover cursor-default ${
                hoveredIndex === i ? 'border-white/[0.15] bg-[#c29b7f]/[0.04]' : ''
              }`}
            ...
            >
              <div className={`w-12 h-12  flex items-center justify-center border transition-all duration-500 mb-5 ${
                hoveredIndex === i
                  ...
                  : 'bg-[#c29b7f]/[0.06] text-white border-white/10'
              }`}>
                {service.icon}
              </div>
              ...
              <p className={`text-[#c29b7f] text-sm leading-relaxed mb-5 font-light ${fontClass}`}>
                {service.description}
              </p>
              ...
              <div className="flex flex-wrap gap-2">
                {service.features.map((feature, j) => (
                  <span
                    key={j}
                    className={`text-[11px] font-medium uppercase tracking-wider px-3 py-1.5  border border-white/[0.08] text-[#c29b7f]/70 bg-white/[0.02] ${ar ? 'tracking-normal normal-case text-xs' : ''}`}
                  >
                    {feature}
                  </span>
                ))}
        ...
        <div className="mt-16 sm:mt-20">
          ...
          >
            {/* Background glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-white/[0.02]  blur-[100px]" />

            <div className="relative z-10">
              <div className="inline-flex items-center justify-center w-16 h-16  bg-[#c29b7f]/[0.06] border border-white/[0.10] mb-6">
              ...
              <p className={`text-[#c29b7f] max-w-lg mx-auto text-sm sm:text-base font-light mb-8 ${fontClass}`}>
                {t('customDesc')}
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-2xl mx-auto mb-8">
                {[
                  ...
                  <SpotlightCard
                    key={item.label}
                    className="px-3 py-3  bg-[#c29b7f]/[0.04] border border-white/[0.06] text-center"
                    spotlightSize={200}
                    spotlightOpacity={0.08}
                  >
                    <span className="text-xl block mb-1">{item.icon}</span>
                    <span className="text-[10px] font-medium text-[#c29b7f] uppercase tracking-wider">{item.label}</span>
                  </SpotlightCard>
                ))}
              </div>
              ...
              <a
                ...
                className={`inline-flex items-center gap-3 px-8 py-4 bg-[#25D366] hover:bg-[#20BD5C] text-white font-semibold text-sm  transition-all duration-300 hover:scale-[1.02] ${fontClass}`}
              >
