  ...
  return (
    <section id="services" className="relative py-24 sm:py-32 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
        <div className="animate-blob-1 absolute -top-20 left-[20%] w-[500px] h-[500px] rounded-full bg-[#B38F6F]/[0.025] blur-[120px]" />
        <div className="animate-blob-2 absolute top-[40%] -right-20 w-[400px] h-[400px] rounded-full bg-orange-500/[0.02] blur-[110px]" />
        <div className="animate-blob-3 absolute bottom-[-10%] left-[10%] w-[450px] h-[450px] rounded-full bg-[#710014]/[0.04] blur-[100px]" />
      </div>
          ...
          {services.map((service, i) => (
            <SpotlightCard
              ...
              className={`group bento-card p-7 sm:p-8 glow-border-hover cursor-default ${
                hoveredIndex === i ? 'border-[#B38F6F]/[0.25] bg-[#B38F6F]/[0.04]' : ''
              }`}
            ...
            >
              <div className={`w-12 h-12 rounded-xl flex items-center justify-center border transition-all duration-500 mb-5 ${
                hoveredIndex === i
                  ...
                  : 'bg-[#B38F6F]/[0.06] text-[#F2F1ED] border-[#B38F6F]/15'
              }`}>
                {service.icon}
              </div>

              <h3 className={`text-lg sm:text-xl font-bold text-[#F2F1ED] mb-2 tracking-tight ${fontClass}`}>
                {service.title}
              </h3>
              <p className={`text-[#B38F6F] text-sm leading-relaxed mb-5 font-light ${fontClass}`}>
                {service.description}
              </p>
              ...
              <div className="flex flex-wrap gap-2">
                {service.features.map((feature, j) => (
                  <span
                    key={j}
                    className={`text-[11px] font-medium uppercase tracking-wider px-3 py-1.5 rounded-lg border border-[#B38F6F]/[0.15] text-[#B38F6F]/70 bg-white/[0.02] ${ar ? 'tracking-normal normal-case text-xs' : ''}`}
                  >
                    {feature}
                  </span>
                ))}
        ...
        <div className="mt-16 sm:mt-20">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#B38F6F]/[0.06] border border-[#B38F6F]/[0.18] mb-6">
                <svg className="w-7 h-7 text-[#F2F1ED]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <h3 className={`text-2xl sm:text-3xl font-bold text-[#F2F1ED] mb-3 tracking-tight ${fontClass}`}>
                {t('customTitle')}
              </h3>
              <p className={`text-[#B38F6F] max-w-lg mx-auto text-sm sm:text-base font-light mb-8 ${fontClass}`}>
                {t('customDesc')}
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-2xl mx-auto mb-8">
                {[
                  ...
                  <SpotlightCard
                    key={item.label}
                    className="px-3 py-3 rounded-xl bg-[#B38F6F]/[0.04] border border-[#B38F6F]/[0.10] text-center"
                    spotlightSize={200}
                    spotlightOpacity={0.08}
                  >
                    <span className="text-xl block mb-1">{item.icon}</span>
                    <span className="text-[10px] font-medium text-[#B38F6F] uppercase tracking-wider">{item.label}</span>
                  </SpotlightCard>
                ))}
              </div>
              ...
              <a
                ...
                className={`inline-flex items-center gap-3 px-8 py-4 bg-[#25D366] hover:bg-[#20BD5C] text-[#F2F1ED] font-semibold text-sm rounded-xl transition-all duration-300 hover:scale-[1.02] ${fontClass}`}
              >
