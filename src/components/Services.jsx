          ...
          {services.map((service, i) => (
            <SpotlightCard
              ...
              className={`group bento-card p-7 sm:p-8 glow-border-hover cursor-default ${
                hoveredIndex === i ? 'border-white/[0.15] bg-[#B38F6F]/[0.04]' : ''
              }`}
            ...
            >
              <div className={`w-12 h-12 rounded-xl flex items-center justify-center border transition-all duration-500 mb-5 ${
                hoveredIndex === i
                  ...
                  : 'bg-[#B38F6F]/[0.06] text-[#F2F1ED] border-white/10'
              }`}>
                {service.icon}
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                {service.features.map((feature, j) => (
                  <span
                    key={j}
                    className={`text-[11px] font-medium uppercase tracking-wider px-3 py-1.5 rounded-lg border border-white/[0.08] text-[#B38F6F]/70 bg-white/[0.02] ${ar ? 'tracking-normal normal-case text-xs' : ''}`}
                  >
                    {feature}
                  </span>
                ))}
        ...
        <div className="mt-16 sm:mt-20">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#B38F6F]/[0.06] border border-white/[0.10] mb-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-2xl mx-auto mb-8">
                {[
                  ...
                  <SpotlightCard
                    key={item.label}
                    className="px-3 py-3 rounded-xl bg-[#B38F6F]/[0.04] border border-white/[0.06] text-center"
                    spotlightSize={200}
