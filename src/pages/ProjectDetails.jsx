...
export default function ProjectDetails() {
  ...
  if (loading) return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-[#050507]/80 backdrop-blur-md">
  ...
  if (!project) return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-[#050507]/80 backdrop-blur-md">
      <div className="text-center">
        ...
        <button onClick={() => navigate('/store')} className="px-5 py-2 bg-[#710014] text-[#F2F1ED] text-sm font-semibold rounded-lg hover:bg-[#5a0010] transition-all">Back to Store</button>
      </div>
    </div>
  )
