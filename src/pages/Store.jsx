  ...
  if (success) {
    return (
      <div className="text-center py-6">
        ...
        <button onClick={onClose} className="px-6 py-2.5 bg-[#710014] text-[#F2F1ED] text-sm font-semibold rounded-xl hover:bg-[#5a0010] transition-all">Done</button>
      </div>
    )
  }
    ...
    <div className="space-y-5">
      ...
      <div className="bg-[#B38F6F]/[0.03] border border-white/[0.06] rounded-xl p-4">
        ...
        <ol className="space-y-1.5 text-xs text-[#B38F6F] font-light">
          ...
          <li className="flex items-start gap-2"><span className="w-4 h-4 rounded-full bg-[#B38F6F]/[0.07] text-[#B38F6F]/70 flex items-center justify-center text-[9px] font-bold shrink-0 mt-0.5">2</span> Send exactly <span className="text-[#F2F1ED] font-medium">{numericTotal} USDT</span> on the <span className="text-[#F2F1ED] font-medium">{network}</span> network.</li>
          <li className="flex items-start gap-2"><span className="w-4 h-4 rounded-full bg-[#B38F6F]/[0.07] text-[#B38F6F]/70 flex items-center justify-center text-[9px] font-bold shrink-0 mt-0.5">3</span> Copy the Transaction Hash (TxID) from your wallet.</li>
          <li className="flex items-start gap-2"><span className="w-4 h-4 rounded-full bg-[#B38F6F]/[0.07] text-[#B38F6F]/70 flex items-center justify-center text-[9px] font-bold shrink-0 mt-0.5">4</span> Paste it below and confirm payment.</li>
        </ol>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <button type="submit" disabled={loading || !txHash.trim()}
          className="w-full py-3.5 bg-[#710014] text-[#F2F1ED] text-sm font-bold rounded-xl hover:bg-[#5a0010] transition-all uppercase tracking-wider disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2">
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-1">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/[0.06]">
                  ...
                  <button onClick={e => { e.stopPropagation(); handleBuy(project) }}
                    className={`px-5 py-2 bg-[#710014] text-[#F2F1ED] text-xs font-semibold rounded-full hover:bg-[#5a0010] transition-all duration-300 uppercase tracking-wider ${ar ? 'tracking-normal normal-case text-sm' : ''}`}>
                    Buy Now
                  </button>
                </div>
              </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
          ...
          <div className="relative w-full max-w-md max-h-[90vh] overflow-y-auto bg-[#0d0d11] border border-white/[0.08] rounded-2xl p-6 sm:p-8 shadow-2xl shadow-black/60 animate-fade-in-up">
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => setCheckoutProduct(null)} className="p-2 text-[#B38F6F]/70 hover:text-[#F2F1ED] transition-colors rounded-lg hover:bg-[#B38F6F]/5">
